...
PER_ORG = {  # doc id -> {org: (code, text, none-kind)}
 ...
 "A/337": {"TTA": ("partial", "Event delivery via DASH events / HbbTV application signaling in IBB Part 2; A/337 EventStream/emsg mechanism not adopted as such"), "SBTVD": ("review", "Ginga event handling (OG-08) — equivalence not established")},
